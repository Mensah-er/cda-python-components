...
#####
# GDA-specific Resource and Topic Names
# (for Gateway Device/Service communications)
#####

# Example GDA topics (you can expand if needed)
GDA_SENSOR_DATA_MSG_RESOURCE         = PRODUCT_NAME + '/' + GATEWAY + '/' + SENSOR_MSG
GDA_ACTUATOR_CMD_MSG_RESOURCE        = PRODUCT_NAME + '/' + GATEWAY + '/' + ACTUATOR_CMD
GDA_ACTUATOR_RESPONSE_MSG_RESOURCE   = PRODUCT_NAME + '/' + GATEWAY + '/' + ACTUATOR_RESPONSE
GDA_MGMT_STATUS_MSG_RESOURCE         = PRODUCT_NAME + '/' + GATEWAY + '/' + MGMT_STATUS_MSG
GDA_MGMT_CMD_MSG_RESOURCE            = PRODUCT_NAME + '/' + GATEWAY + '/' + MGMT_STATUS_CMD
GDA_UPDATE_NOTIFICATIONS_MSG_RESOURCE= PRODUCT_NAME + '/' + GATEWAY + '/' + UPDATE_NOTIFICATIONS_MSG
GDA_REGISTRATION_REQUEST_RESOURCE    = PRODUCT_NAME + '/' + GATEWAY + '/' + RESOURCE_REGISTRATION_REQUEST
GDA_SYSTEM_PERF_MSG_RESOURCE         = PRODUCT_NAME + '/' + GATEWAY + '/' + SYSTEM_PERF_MSG

# Backwards-compatible aliases if needed
GDA_SENSOR_MSG           = GDA_SENSOR_DATA_MSG_RESOURCE
GDA_ACTUATOR_CMD         = GDA_ACTUATOR_CMD_MSG_RESOURCE
GDA_SYSTEM_PERF_MSG      = GDA_SYSTEM_PERF_MSG_RESOURCE
...
DEFAULT_CONFIG_FILE_NAME = '/home/ernest/piot/cda-python-components/config/PiotConfig.props'
