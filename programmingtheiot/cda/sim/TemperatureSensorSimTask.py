...
class TemperatureSensorSimTask(BaseSensorSimTask):
    """
    Legacy Temperature Sensor Sim Task
    """
...
class TemperatureSensorEmulatorTask(TemperatureSensorSimTask):
    """
    Emulated Temperature Sensor Task (subclass of legacy simulator)
    """
    pass
