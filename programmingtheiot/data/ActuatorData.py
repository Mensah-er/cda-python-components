...
class ActuatorData(BaseIotData):
	"""
	Implementation of ActuatorData derived from BaseIotData.
	Represents actuator commands, values, and optional state info.
	"""
	...
	def __str__(self):
		...
		"""
		parentStr = super(ActuatorData, self).__str__()
		return parentStr + f",command={self.command},value={self.value},stateData={self.stateData},isResponse={self.isResponse}"
